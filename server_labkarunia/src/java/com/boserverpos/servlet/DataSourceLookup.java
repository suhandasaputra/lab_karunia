...
//        DatasourceEntry.getInstance().setMbdatasource(getDataSource("jdbc/ppobdevds"));
//        com.balimuda.agent.singleton.DatasourceEntryAgentManagement.getInstance().setAgentDS(getDataSource("jdbc/ppobdevds"));
//        com.balimuda.backend.singleton.DatasourceEntryBackend.getInstance().setBackendDS(getDataSource("jdbc/ppobdevds"));

//        DatasourceEntry.getInstance().setMbdatasource(getDataSource("jdbc/bopos_server"));
        DatasourceEntryBackend.getInstance().setBackendDS(getDataSource("jdbc/labkarunia"));
    }
