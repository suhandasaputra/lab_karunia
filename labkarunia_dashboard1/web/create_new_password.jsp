<%-- 
    ...
    Created on : 20-Feb-2020, 22:45:08
    Author     : matajari
--%>
        ...
        <div id="isi">
            ...
            <div id="box2">
                <div id="form" align="center">
                    ...
                    <label id="welcomeback">Create New Password</label>
                    <br>
                    <form id="form_nya">
                        <input type="password" required="" placeholder="Create new password">
                        <br>
                        <input type="password" required="" placeholder="Re-type new password">
                        <br>
                        <br>
                        <br>
                        <div id="login_button">
