        ...
        <div id="isi">
                ...
                <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img class="d-block w-100" src="image/lab1.jpg" alt="First slide" style="height: 695px">
                        </div>
                        <div class="carousel-item">
                            <img class="d-block w-100" src="image/lab2.jpg" alt="Second slide" style="height: 695px">
                        </div>
                        <div class="carousel-item">
                            <img class="d-block w-100" src="image/lab3.jpg" alt="Third slide" style="height: 695px">
                        </div>
                        <div class="carousel-item">
                            <img class="d-block w-100" src="image/lab4.jpeg" alt="Fourth slide" style="height: 695px">
                        </div>
                    </div>
            ...
            <div id="box2">
                <div id="form" align="center">
                    <strong><label id="title_form">LAB KARUNIA</label></strong><br>
                    <label id="welcomeback">Welcome back !<br><strong>Please login to your account</strong></label>
                    <br><br>
                    <form>                       
                        ...
                        <input id="user" type="text" required="" placeholder="user id">
                        <br>
            ...
            function login() {
                ...
                if (user == "") {
                    ...
                    if (pass == "") {
                        ...
                        datjson.procCode = "100001";
                        datjson.user_id = user;
                        datjson.password = SHA256(pass);
                        $.ajax({
                            ...
                            success: function (response) {
                                if (response.respCode == 0000) {
                                    ...
                                    window.localStorage.setItem('lab_user_id', user);
                                    window.localStorage.setItem('userlevel', response.userlevel);
                                    window.localStorage.setItem('lab_user_name', response.name);
