...
<style>
    ...
    .cd-popup-edit-pasien.is-visible {
        opacity: 1;
        visibility: visible;
    ...
    .cd-popup-edit-pasien-container {
        position: relative;
        width: 90%;
        height: 680px;
        max-width: 500px;
    ...
    .cd-popup-edit-pasien-container .cd-buttons-edit-pasien:after {
        content: "";
        display: table;
        clear: both;
    }
    .cd-popup-edit-pasien-container .cd-buttons-edit-pasien li {
        float: left;
        width: 50%;
        list-style: none;
    }
    .cd-popup-edit-pasien-container .cd-buttons-edit-pasien div {
        cursor: pointer;
        display: block;
        height: 60px;
        line-height: 60px;
    ...
    .cd-popup-edit-pasien-container .cd-buttons-edit-pasien li:first-child div {
        background: #3dceb7;
        border-radius: 0 0 0 .25em;
    }
    .cd-popup-edit-pasien-container .cd-buttons-edit-pasien li:first-child div:hover {
        background: #52e4cd;
        border-radius: 0 0 0 .25em;
    }

    .no-touch .cd-popup-edit-pasien-container .cd-buttons-edit-pasien li:first-child div:hover {
        background-color: #fc8982;
    }
    .cd-popup-edit-pasien-container .cd-buttons-edit-pasien li:last-child div {
        background: #b6bece;
        border-radius: 0 0 .25em 0;
    }
    .cd-popup-edit-pasien-container .cd-buttons-edit-pasien li:last-child div:hover {
        background: #d1d9e8;
        border-radius: 0 0 .25em 0;
    }
    .no-touch .cd-popup-edit-pasien-container .cd-buttons-edit-pasien li:last-child div:hover {
        background-color: #c5ccd8;
    }
    .cd-popup-edit-pasien-container .cd-popup-edit-pasien-close {
        position: absolute;
        top: 8px;
        right: 8px;
        width: 30px;
    ...
    .cd-popup-edit-pasien-container .cd-popup-edit-pasien-close::before, .cd-popup-edit-pasien-container .cd-popup-edit-pasien-close::after {
        content: '';
        position: absolute;
        top: 12px;
        width: 14px;
    ...
    .cd-popup-edit-pasien-container .cd-popup-edit-pasien-close::before {
    ...
    .cd-popup-edit-pasien-container .cd-popup-edit-pasien-close::after {
        -webkit-transform: rotate(-45deg);
        -moz-transform: rotate(-45deg);
        -ms-transform: rotate(-45deg);
        -o-transform: rotate(-45deg);
    ...
    .is-visible .cd-popup-edit-pasien-container {
...
//    jQuery(document).ready(function ($) {
        function popupeditpasien() {
            ...
            $('#table_listpasien').on('click', 'td:nth-child(-n+14)', function () {

                var row = $(this).closest('tr');
                var patient_id = $('#table_listpasien').DataTable().row(row).data().patient_id;

                var datjson5 = new Object();
                datjson5.procCode = "400008";
                datjson5.user_id = window.localStorage.getItem('lab_user_id');
                datjson5.patient_id = patient_id;
                $.ajax({
                    contentType: 'application/json',
                    dataType: "json",
                    url: "http://www.app.mobatech.net:80/KaruniaLAB/API",
                    ...
                    success: function (response) {
                        if (response.respCode == 0000) {
                            ...
                            if (response.status == '1') {
                                document.getElementById("status").innerHTML = '<label class="switch"><input type="checkbox" id="change_spropas" checked=""><div class="slider round"></div></label>';
                            } else if (response.status == '0') {
                                document.getElementById("status").innerHTML = '<label class="switch"><input type="checkbox" id="change_spropas"><div class="slider round"></div></label>';
                            }
                            ...
                            var span6 = document.getElementById('mancap');
                            span6.onclick = function () {
                                modal.style.display = "none";
                            };
                            $('.cd-popup-edit-pasien').addClass('is-visible');
                        } else {
            ...
            $('.cd-popup-edit-pasien').on('click', function (event) {
                if ($(event.target).is('.cd-popup-edit-pasien-close') || $(event.target).is('.cd-popup-edit-pasien') || $(event.target).is('#btn_cancel')) {
                    event.preventDefault();
                    document.getElementById("myModal").style.display = 'none';
                    $(this).removeClass('is-visible');
                    $("#form-edit-pasien")[0].reset();
//                $('#img_ktp1').prop('src', 'image/upload_icon.jpeg');
            ...
            $(document).keyup(function (event) {
                if (event.which == '27') {
                    document.getElementById("myModal").style.display = 'none';
                    $('.cd-popup-edit-pasien').removeClass('is-visible');
                }
            });
        }
...
<div class="cd-popup-edit-pasien" role="alert">
    <div class="cd-popup-edit-pasien-container">
        <label id="label-edit-pasien">Edit Pasien</label>
        <div id="boxx-edit-pasien">
            <div id="box1-edit-pasien">
            ...
            <div id="myModal" class="modal">
                <span class="close" id="mancap">&times;</span>
                <img class="modal-content" id="img01">
            </div>
            <div id="box2-edit-pasien">
                <div id="input-edit-pasien">
                    <form id="form-edit-pasien">
                        <div id="close" class="modal">
                        ...
                        <!--<input type="text" id="edit_regispasien_gender" required="" placeholder="gender">-->
                        ...
                        <!--<input type="text" id="edit_regispasien_nation" required="" placeholder="nationality">-->
                    ...
                    <div id="buttonon">
                        ...
                        <div id="btn_delete_pasien">Delete</div>
        ...
        <a href="#0" class="cd-popup-edit-pasien-close img-replace-edit-pasien">Close</a>
    </div>
</div>
<script>
    jQuery(document).ready(function ($) {
        ...
        $('#btn_save').on('click', function () {
            ...
            var status = document.getElementById('change_spropas').checked;
                                        ...
                                        if (edit_regispasien_adress == "") {
                                            ...
                                            if (edit_regispasien_email == "") {
                                                ...
                                                if (edit_regispasien_phone == "") {
                                                    ...
                                                    datjson6.procCode = "500008";
                                                    datjson6.user_id = user;
                                                    datjson6.patient_id = edit_regispasien_code;
                                                    datjson6.idcard_number = edit_regispasien_identitynumber;
                                                    datjson6.passport_number = edit_regispasien_passport;
                                                    datjson6.name = edit_regispasien_name;
                                                    datjson6.gender = edit_regispasien_gender;
                                                    datjson6.birth_date = edit_regispasien_birthday;
                                                    datjson6.citizenship = edit_regispasien_nation;
                                                    datjson6.address = edit_regispasien_adress;
                                                    datjson6.email = edit_regispasien_email;
                                                    datjson6.phonenumber = edit_regispasien_phone;
//                                                    datjson.status = edit_regispasien_code;

                                                    var edit_status = "0";
                                                    if (status) {
                                                        edit_status = "1";
                                                    }
                                                    datjson6.status = edit_status;
                                                    ...
                                                    $.ajax({
                                                        ...
                                                        success: function (response) {
                                                            if (response.respCode == 0000) {
                                                                destroyPasien();
                                                                getlistPasien();
                                                                alert('Success Update Pasien Data');
                                                                $('.cd-popup-edit-pasien').removeClass('is-visible');
                                                            } else {
                                                                alert('Failed Update Pasien Data : ' + response.respDesc);
                                                            }
                                                        }
                                                    });
                                                }
        ...
        $('#btn_delete_pasien').on('click', function () {
            var edit_regispasien_code = document.getElementById('edit_regispasien_code').value;
            ...
            if (edit_regispasien_code == "") {
                push.innerHTML = "<p>patient id must be fill</p>";
                modal.style.display = "block";
                span.onclick = function () {
                    modal.style.display = "none";
                }
                ...
                datjson3.procCode = "600008";
                datjson3.user_id = window.localStorage.getItem('lab_user_id');
                datjson3.patient_id = edit_regispasien_code;
                $.ajax({
                    contentType: 'application/json',
                    dataType: "json",
                    url: "http://www.app.mobatech.net:80/KaruniaLAB/API",
                    ...
                    success: function (response) {
                        if (response.respCode == 0000) {
                            destroyPasien();
                            getlistPasien();
                            alert('Success Delete Pasien Data');
                            $('.cd-popup-edit-pasien').removeClass('is-visible');
                        } else {
                            alert('Failed Delete Pasien Data : ' + response.respDesc);
                        }
                    }
                });
            }
