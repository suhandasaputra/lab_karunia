...
function hema(myArray, good_game, ext, ggwp, myIndex) {
...
function koag(myArray, good_game, ext, ggwp) {
...
function kimia(myArray, good_game, ext, ggwp) {
...
function sero(myArray, good_game, ext, ggwp) {
...
function hepa(myArray, good_game, ext, ggwp) {
...
function urin(myArray, good_game, ext, ggwp) {
...
function nark(myArray, good_game, ext, ggwp) {
...
function faec(myArray, good_game, ext, ggwp) {
...
function sekr(myArray, good_game, ext, ggwp) {
...
function sput(myArray, good_game, ext, ggwp) {
