...
<div class="cd-popup-add-outlet" role="alert">
    <div class="cd-popup-add-outlet-container">
        <label id="label_add_outlet">Add Branch</label>
            ...
            <div id="box2_add_outlet">
                <div id="input_add_outlet">
                    <form id="form_add_outlet">
                        ...
                        <input type="text" id="outlet_name_add_outlet" name="outlet_name_add_outlet" required="" placeholder="Branch Name">
                        <input type="text" id="outlet_address_add_outlet" name="outlet_address_add_outlet" required="" placeholder="Branch Address">
                        <div id="buttonon">
