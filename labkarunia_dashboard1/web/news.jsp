    ...
    <head>
        ...
        <script>
            ...
            function destroyNews() {
                $('#table_news').dataTable().fnClearTable();
                $('#table_news').dataTable().fnDestroy();
            }
            function getListNews() {
                var datjson1 = new Object();
                datjson1.procCode = "200007";
                                ...
                                "columns": [
                                    ...
                                    {data: "img",
                                        "render": function (data) {
                                            return '<img height="80px" width="80px" src="' + data + '"/>';
                                        }
                                    },
                                    {data: "createby"},
                                    {data: "createdate"},
                                                ...
                                                <div class="tab-content" style="width: 100%">
                                                    <div id="news" class="tab-pane fade in active show">
                                                        <div class="container" id="ref_tabel_item">    
                                                            <label id="add_news" style="cursor: pointer; padding: 10px; color: #29b19c; font-weight: 400"><i class="icon fa fa-plus-circle" style="margin-right: 10px"></i>Create News</label>
                                                        </div>
                                                        <br>
                                                        <table class="table" id="table_news" style="font-size: 12px; width: 100%">
                                                            <thead>
                                                                <tr>
                                                                    <th>news id</th>
                                                                    <th>title</th>
                                                        ...
                                                        <%@include file='pop_up_add_news.jsp'%>
                                                        <%@include file='pop_up_edit_news.jsp'%>
                                                    </div>
                                                </div>    
                                            </div>
                                            <!-- /.row -->
