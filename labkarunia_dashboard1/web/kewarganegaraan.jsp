...
<html lang="en">
    <head>
        ...
        <script>
            ...
            function destroyKwn() {
                $('#table_kwn').dataTable().fnClearTable();
                $('#table_kwn').dataTable().fnDestroy();
            }


            function getlistKwn() {
                var datjson = new Object();
                datjson.procCode = "200004";
                                        ...
                                        render: function (data) {
                                            if (data === '1') {
                                                return '<label class="switch">'
                                                        + '<input type="checkbox" id="change_kwnstatus" checked disabled>'
                                                        + '<div class="slider round"></div>'
                                                        + '</label>';
                                            } else {
                                                return '<label class="switch">'
                                                        + '<input type="checkbox" id="change_kwnstatus" disabled>'
                                                        + '<div class="slider round"></div>'
                                                        + '</label>';
                                            }
                                        }
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="row">
                                                <div class="tab-content" style="width: 100%">
                                                    <div id="kewarganegaraan" class="tab-pane fade in active show">
                                                        <div class="container" id="ref_tabel_item">    
                                                            <label id="add_kwn" style="cursor: pointer; padding: 10px; color: #29b19c; font-weight: 400"><i class="icon fa fa-plus-circle" style="margin-right: 10px"></i>Create Kewarganegaraan</label>
                                                        </div>
                                                        <br>
                                                        <table class="table" id="table_kwn" style="font-size: 12px; width: 100%">
                                                            <thead>
                                                                <tr>
                                                                    <th>code</th>
                                                                    <th>name</th>
                                                        ...
                                                        <%@include file='pop_up_add_kwn.jsp'%>
                                                        <%@include file='pop_up_edit_kwn.jsp'%>
                                                    </div>
                                                </div>    
                                            </div>
                                            <!-- /.row -->
