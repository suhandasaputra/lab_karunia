...
import com.bopro.process.addinstitusi;
import com.bopro.process.addjasa;
import com.bopro.process.addkwn;
import com.bopro.process.addlab;
import com.bopro.process.addoutlet;
import com.bopro.process.addsalesman;
import com.bopro.process.addsupplier;
import com.bopro.process.addtipem;
import com.bopro.process.addtujuancek;
...
import com.bopro.process.deleteinstitusi;
import com.bopro.process.deleteitem;
import com.bopro.process.deletejasa;
import com.bopro.process.deletekwn;
import com.bopro.process.deletelab;
import com.bopro.process.deleteoutlet;
import com.bopro.process.deletesalesman;
import com.bopro.process.deletesupplier;
import com.bopro.process.deletetipem;
import com.bopro.process.deletetujuancek;
...
import com.bopro.process.editinstitusi;
import com.bopro.process.edititem;
import com.bopro.process.editjasa;
import com.bopro.process.editkwn;
import com.bopro.process.editlab;
import com.bopro.process.editoutlet;
import com.bopro.process.editpassword;
import com.bopro.process.editphonenumber;
import com.bopro.process.editsalesman;
import com.bopro.process.editsupplier;
import com.bopro.process.edittipem;
import com.bopro.process.edittujuancek;
...
import com.bopro.process.getlistinstitusi;
import com.bopro.process.getlistjasa;
import com.bopro.process.getlistkwn;
import com.bopro.process.getlistlab;
import com.bopro.process.getlistmerchant;
import com.bopro.process.getlistsalesman;
import com.bopro.process.getlistsupplier;
import com.bopro.process.getlisttipem;
import com.bopro.process.getlisttujuancek;
...
import com.bopro.process.getoptionsales;
...
//                input = new additem().process(input);
            ...
            }else if (ProcessingCode.getlistlab.equals(input.get(FieldParameterMatapos.proccode).toString())) {
                input = new getlistlab().process(input);
            } else if (ProcessingCode.addlab.equals(input.get(FieldParameterMatapos.proccode).toString())) {
                input = new addlab().process(input);
            } else if (ProcessingCode.editlab.equals(input.get(FieldParameterMatapos.proccode).toString())) {
                input = new editlab().process(input);
            } else if (ProcessingCode.deletelab.equals(input.get(FieldParameterMatapos.proccode).toString())) {
                input = new deletelab().process(input);
            }
            
            else if (ProcessingCode.getlistsalesman.equals(input.get(FieldParameterMatapos.proccode).toString())) {
                input = new getlistsalesman().process(input);
            } else if (ProcessingCode.addsalesman.equals(input.get(FieldParameterMatapos.proccode).toString())) {
                input = new addsalesman().process(input);
            } else if (ProcessingCode.editsalesman.equals(input.get(FieldParameterMatapos.proccode).toString())) {
                input = new editsalesman().process(input);
            } else if (ProcessingCode.deletesalesman.equals(input.get(FieldParameterMatapos.proccode).toString())) {
                input = new deletesalesman().process(input);
            }
            
            else if (ProcessingCode.getlistinstitusi.equals(input.get(FieldParameterMatapos.proccode).toString())) {
                input = new getlistinstitusi().process(input);
            } else if (ProcessingCode.addinstitusi.equals(input.get(FieldParameterMatapos.proccode).toString())) {
                input = new addinstitusi().process(input);
            } else if (ProcessingCode.editinstitusi.equals(input.get(FieldParameterMatapos.proccode).toString())) {
                input = new editinstitusi().process(input);
            } else if (ProcessingCode.deleteinstitusi.equals(input.get(FieldParameterMatapos.proccode).toString())) {
                input = new deleteinstitusi().process(input);
            }
            else if (ProcessingCode.getlistjasapelayanan.equals(input.get(FieldParameterMatapos.proccode).toString())) {
                input = new getlistjasa().process(input);
            } else if (ProcessingCode.addjasapelayanan.equals(input.get(FieldParameterMatapos.proccode).toString())) {
                input = new addjasa().process(input);
            } else if (ProcessingCode.editjasapelayanan.equals(input.get(FieldParameterMatapos.proccode).toString())) {
                input = new editjasa().process(input);
            } else if (ProcessingCode.deletejasapelayanan.equals(input.get(FieldParameterMatapos.proccode).toString())) {
                input = new deletejasa().process(input);
            }
             else if (ProcessingCode.getlisttujuancek.equals(input.get(FieldParameterMatapos.proccode).toString())) {
                input = new getlisttujuancek().process(input);
            } else if (ProcessingCode.addtujuancek.equals(input.get(FieldParameterMatapos.proccode).toString())) {
                input = new addtujuancek().process(input);
            } else if (ProcessingCode.edittujuancek.equals(input.get(FieldParameterMatapos.proccode).toString())) {
                input = new edittujuancek().process(input);
            } else if (ProcessingCode.deletetujuancek.equals(input.get(FieldParameterMatapos.proccode).toString())) {
                input = new deletetujuancek().process(input);
            }
             else if (ProcessingCode.getlistwkn.equals(input.get(FieldParameterMatapos.proccode).toString())) {
                input = new getlistkwn().process(input);
            } else if (ProcessingCode.addkwn.equals(input.get(FieldParameterMatapos.proccode).toString())) {
                input = new addkwn().process(input);
            } else if (ProcessingCode.editkwn.equals(input.get(FieldParameterMatapos.proccode).toString())) {
                input = new editkwn().process(input);
            } else if (ProcessingCode.deletekwn.equals(input.get(FieldParameterMatapos.proccode).toString())) {
                input = new deletekwn().process(input);
            }
             ...
             else if (ProcessingCode.getlistipem.equals(input.get(FieldParameterMatapos.proccode).toString())) {
                input = new getlisttipem().process(input);
            } else if (ProcessingCode.addtipem.equals(input.get(FieldParameterMatapos.proccode).toString())) {
                input = new addtipem().process(input);
            } else if (ProcessingCode.edittipem.equals(input.get(FieldParameterMatapos.proccode).toString())) {
                input = new edittipem().process(input);
            } else if (ProcessingCode.deletetipem.equals(input.get(FieldParameterMatapos.proccode).toString())) {
                input = new deletetipem().process(input);
            }
            
             else if (ProcessingCode.getoptionsales.equals(input.get(FieldParameterMatapos.proccode).toString())) {
                input = new getoptionsales().process(input);
            }
