                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="row">
                                                <ul class="nav nav-tabs topnav" id="myTab">
                                                    ...
                                                    <li><a data-toggle="tab" href="#brand" class="active">Main</a></li>
                                                    <li><a data-toggle="tab" href="#outlet">Branch</a></li>
                                                </ul>
                                            </div>
                                            <div class="row">
                                                <div class="tab-content" style="width: 100%">
                                                            ...
                                                            <div id="account_body" class="tab-content" style="width: 100%">
                                                                <div id="account_right">
                                                                    <div id="account_biodata">
                                                                        Main Profile<br><br>
                                                                        <label style="color: #CCC; font-size: 16px; font-weight: 400;">ID</label>
                                                                        <input disabled="" type="text" id="brand_id" readonly=""><br>
                                                                        <label style="color: #CCC; font-size: 16px; font-weight: 400;">Name</label>
                                                                        <input disabled="" type="text" id="brand_name" readonly="">
                                                                        <label id="edit_brand_name">Edit</label>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div id="outlet" class="tab-pane fade">
                                                        <div class="container" id="ref_tabel_item">    
                                                            <label id="add_outlet"><i class="icon fa fa-plus-circle" style="margin-right: 10px"></i>Add Branch</label>
                                                        </div>
                                                        <br>
                                                        ...
                                                        <%@include file='pop_up_add_outlet.jsp'%>
                                                        <%@include file='pop_up_edit_outlet.jsp'%>
                                                    </div>
                                                </div>    
                                            </div>
                                            <!-- /.row -->
