...
<div class="cd-popup-add-user" role="alert">
    <div class="cd-popup-add-user-container">
        <label id="label_add_user">Add User</label>
            ...
            <div id="box2_add_user">
                <div id="input_add_user">
                    <form id="form_add_user">
                        ...
                        <label style="margin-bottom: 0px; font-size: 10px; float: left; font-weight: 100">Branch</label><select id="outlet_id_user" style="width: 215px; padding: 0px; margin-bottom: 5px;" name="outlet_id_user"></select>
