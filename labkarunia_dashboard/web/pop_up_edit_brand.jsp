...
<div class="cd-popup-edit-brand" role="alert">
    <div class="cd-popup-edit-brand-container">
        <label id="label_edit_brand">Edit Main</label>
        <div id="boxx_brand">
            <div id="box2_brand">
                <div id="input_brand">
                    <form id="formho_brand">
                        <label style="font-weight: 100;
                               ...
                               color: black;
                               font-size: 12px;">id</label>
                        <input type="text" id="brand_id_edit" name="brand_id_edit" required="" placeholder="id" readonly="" style="background-color: aquamarine">
                        <label style="font-weight: 100;
                               float: left;
                               margin: 0px 0px 1px 0px;
                               color: black;
                               font-size: 12px;">name</label>
                        <input type="text" id="brand_name_edit" name="brand_name_edit" required="" placeholder="name">
                    </form>
                    <div id="buttonon">
