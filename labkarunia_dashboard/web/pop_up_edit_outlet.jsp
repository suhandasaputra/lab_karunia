...
<div class="cd-popup-edit-outlet" role="alert">
    <div class="cd-popup-edit-outlet-container" style="color: #29B19C;">
        <label id="label_add_outlet">Edit Branch</label>
                ...
                <div id="input_add_outlet">
                    <form id="form_edit_outlet">
                        ...
                        <label style="font-weight: 100;
                               ...
                               color: black;
                               font-size: 12px;">branch id</label>
                        <input id="outlet_id1" name="outlet_id1" readonly="" style="background-color: aquamarine;" disabled=""><br>
                        <label style="font-weight: 100;
                               float: left;
                               margin: 0px 0px 1px 0px;
                               color: black;
                               font-size: 12px;">branch name</label>
                        <input type="text" id="outlet_name1" name="outlet_name1" required="" placeholder="Branch Name"><br>
                        <label style="font-weight: 100;
                               float: left;
                               margin: 0px 0px 1px 0px;
                               color: black;
                               font-size: 12px;">branch address</label>
                        <input type="text" id="outlet_address1" name="outlet_address1" required="" placeholder="Branch Address">
                    </form>
                    <div id="buttonon">
