 ...
 * @author suhanda
 */
public class getlistkwn {

    private static Logger log = Logger.getLogger(getlistkwn.class);

    public HashMap process(HashMap input) {
        BackendDBProcess dp = new BackendDBProcess();
        Gson gson = new Gson();
        ArrayList<kewarganegaraan> listcustomer = dp.getlistkewarganegaraan();
        try {
            if (listcustomer != null) {
                JsonElement element = gson.toJsonTree(listcustomer);
                input.put("listkwn", element);
